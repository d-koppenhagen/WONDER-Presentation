...
% telekom Magenta: \definecolor{magentaTele}{RGB}{226,0,116}
\definecolor{magentaTele}{RGB}{226,121,170}
\setbeamercolor{frametitle}{fg=magentaTele}
\setbeamercolor{structure}{fg=magentaTele}
	...
	\begin{frame}
		...
		\only<2->{
			...
			\begin{itemize}[<+->]
				...
				\item File-Transfer {\color[rgb]{0.7,0.7,0}$\nicefrac{1}{2}$}
				\item Kontaktliste
				\begin{itemize}[<+->]
